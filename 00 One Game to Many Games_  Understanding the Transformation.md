...
* **F05: From Collective Ambition to Fragmented Adaptation** maps the shift from unified climate mitigation toward isolated resilience strategies  
* **F06: From From Open Society to Strategic Opacity** traces formal civic participation declining as informal arrangements become primary  
...
Positions aren’t fixed for a given entity—at state, subnational, or sector levels. The same entity might architect one transformation while resisting another. This dynamic positioning, rather than static identity, determines how actors navigate fragmentation and what advantages and challenges they may be facing.
...
**These forecasts are designed as starting points for organisational sense-making, not endpoints**. Different organisations facing different constraints in different contexts will, and should, develop different responses to the same transformation. 

This initial set of forecasts represents 10F's first collective output. The Consortium intends to continue developing foresight on emerging transformations, responding to both the evolving landscape and the needs of organisations navigating it.

These forecasts were developed through the 10F Project, an independent foresight initiative. They represent analytical assessment of systemic transformation, not prediction or prescription. We've cited sources and verified claims where possible, but perfect information doesn't exist when describing systems in transformation. Organisations should evaluate these insights against their own strategic context.

## About These Forecasts

### Approach

Following a call to respond to unfolding global uncertainty within a small, well-qualified professional network, the work began in mid-2025 with months of distributed collaboration, including sharing and testing big themes and signals and developing initial frames. In September 2025, 20+ independent futurists, strategic analysts and domain experts convened in Singapore under the Chatham House Rule, for collective sensemaking and to sketch an initial structure for these forecasts. This allowed participants to speak candidly from their professional experience without institutional constraint. The joint research and writing that followed developed the full analysis. This is strategic intelligence, not academic research—we prioritize pattern recognition over exhaustive citation and directional clarity over probabilistic hedging.

That framing shapes what these forecasts cover and what they don't. The 10F Consortium intentionally didn’t develop separate forecasts for artificial intelligence, climate change, demographics or ageing. We see these as cross-cutting drivers that accelerate and shape the transformations we map. Examples: AI drives technological speciation and opacity engineering, climate pressures fragment cooperation, demographic shifts fuel migration-as-asset-class dynamics. They appear throughout as accelerants and provide contextual clues. The forecasts map directional shifts already underway and changes in how systems operate that organisations must navigate regardless of which specific outcomes materialise, not predictions of specific events or branching scenario pathways.

The forecasts draw on evidence gathered through the practitioner network: observed patterns in policy, regulation and institutional behaviour, analysis of financial flows and strategic investments, expert presentations on domain-specific shifts and collaborative workshops testing frameworks against lived experience. We cite sources for factual claims requiring verification, but don't over-document what practitioners see in their daily work.

### Coverage

These forecasts examine transformation across fifteen interconnected global systems:

Trade Systems | Global Supply Chains | Technology Governance | Financial Architecture | Energy Systems | Climate Mitigation & Adaptation | Migration & Population Movements | Global Health Infrastructure | Digital Information Ecosystem | Security Alliances & Military Technologies | Social Values & Identity Systems | Food Systems | Urban Development & Infrastructure | Civil Society & Democratic Institutions | Global Commons Governance

This set of ten forecasts emerged from examining these domains, identifying where norm cascades are most visible and system-level changes that are most consequential. No single forecast covers all fifteen domains, instead, each traces how specific transformations ripple across multiple systems simultaneously.

The forecasts map these shifts using a “From-To” structure. “From” captures the assumptions and arrangements of the unified system, while “To” describes the emerging, fragmented reality that organisations must now navigate.

### Time

These forecasts map transformations unfolding across 2025–2035, but time itself operates differently within this transition. This isn't ten years of linear change—it's systemic reorganisation that accelerates, stalls and reverses unpredictably across different domains and geographies.

Time is differential. Technological speciation happens faster than institutional adaptation. Financial systems fragment more rapidly than energy infrastructure. Some regions experience transformation as a sudden event, like a coup, a climate disaster, or a supply chain collapse, while others face slow grinding pressure that accumulates imperceptibly until it doesn't. Financial systems can change overnight, while operations built on them can take much longer to rethink or restructure. A data localisation law can immediately prohibit sharing information across borders, but the programs that depend on that data, like health surveillance networks, climate monitoring systems, humanitarian response protocols, can't reorganise in weeks or months.

This means that by 2035, different parts of the world will have experienced profoundly different versions of this transformation—some already stabilised into new equilibria, others still in active fragmentation, some having seen accelerated disorder. An organisation’s strategic horizon must therefore operate on multiple timescales simultaneously: the quarterly pressures of immediate crisis response, the 2–3 year cycles of organisational adaptation, the 5–7 year window for major infrastructure building and the 10+ year timeframe for systemic transformation to crystallise into new stable patterns—or perhaps, fail to evolve at all. Those that develop this multi-timescale fluency will find themselves better positioned than those locked into single planning horizons. 10F was convened to explore these horizons.

**What follows are ten maps of changing terrain. We intend them as future-facing practical intelligence for organisations doing essential work.**