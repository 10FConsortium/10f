...
**These Forecasts are designed as starting points for organisational sensemaking, not endpoints**. Different organisations facing different constraints in different contexts will, and should, develop different responses to the same transformation. 
...
Trade Systems | Global Supply Chains | Technology Governance | Financial Architecture | Energy Systems | Climate Mitigation & Adaptation | Migration & Population Movements | Global Health Infrastructure | Digital Information Ecosystems | Security Alliances & Military Technologies | Social Values & Identity Systems | Food Systems | Urban Development & Infrastructure | Civil Society & Democratic Institutions | Global Commons Governance
